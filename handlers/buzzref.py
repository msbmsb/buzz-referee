...
from google.appengine.ext.webapp import taskqueue
      ...
      if post.placeholder is None:
        ...
        if decision is not None:
          ...
          try:
            ...
            template_values['message'] = "<h2>Error:</h2><br />" + "Writing comment: " + decision + "<br />" + "to post.id = " + post.id + "<br />" + "<pre>"  + traceback.format_exc()  + "</pre>"
